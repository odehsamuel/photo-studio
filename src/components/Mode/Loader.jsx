export function Loader(props) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <circle cx="12" cy="3" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="16.5" cy="4.21" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="7.5" cy="4.21" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="19.79" cy="7.5" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="4.21" cy="7.5" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="21" cy="12" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="3" cy="12" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="19.79" cy="16.5" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="4.21" cy="16.5" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="16.5" cy="19.79" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="7.5" cy="19.79" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
      ...
      <circle cx="12" cy="21" r="0" fill={col ? `${col}` : "currentColor"}>
        <animate
